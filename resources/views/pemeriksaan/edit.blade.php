            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                    ...
                    <div>
                        ...
                        <x-form-select name="dokter_nama" id="dokter_nama" :value="old('dokter_nama', $pemeriksaan->dokter_nama)" onchange="updateDokterNip()" placeholder="-- Pilih Dokter --" :options="[
                    ...
                    <div>
                        ...
                        <x-form-select name="jenis_kelamin" id="jenis_kelamin" :value="old('jenis_kelamin', $pemeriksaan->jenis_kelamin)" placeholder="Pilih..." :options="[
                            'Laki-Laki' => 'Laki-Laki',
                            'Perempuan' => 'Perempuan'
                        ]" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-form-select name="fakultas" id="fakultas" :value="old('fakultas', $pemeriksaan->fakultas)" placeholder="Pilih Fakultas..." :options="[
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                    <div>
                        ...
                        <x-form-select name="kesimpulan" id="kesimpulan" :value="old('kesimpulan', $pemeriksaan->kesimpulan)" required :options="[
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <x-form-select name="buta_warna" id="buta_warna" :value="old('buta_warna', $pemeriksaan->buta_warna ?? 'Tidak')" :options="[
                            'Tidak' => 'Tidak',
                            'Parsial' => 'Parsial',
                            'Ya' => 'Ya'
                        ]" />
